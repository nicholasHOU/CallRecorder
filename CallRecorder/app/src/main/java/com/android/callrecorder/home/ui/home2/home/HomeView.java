...
// * <br> ...
// */
//public class HomeView extends BaseView<Entry<String, String>> implements OnClickListener {
//	private static final String TAG = "DemoView";
//
//	public HomeView(Activity context, ViewGroup parent) {
//		super(context, R.layout.call_history_item, parent);  //TODO demo_view改为你所需要的layout文件
//	}
//
//
//	//示例代码<<<<<<<<<<<<<<<<
